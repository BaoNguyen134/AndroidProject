    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        switch (position) {
            ...
            case 3:
                ...
                progressBarCircular.setBackgroundColor(getResources().getColor(R.color.material_green));

                break;
            case 4:
                fab.setBackgroundColor(getResources().getColor(R.color.material_green));
                progressBarCircular.setBackgroundColor(getResources().getColor(R.color.colorPrimaryDark));
