...
public class SampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{
                "DEFAULT", "RED", "BLUE", "MATERIAL GREY", "GREEN"
        };
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                switch (position) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        mDrawerList.setBackgroundColor(getResources().getColor(R.color.material_green));
                        toolbar.setBackgroundColor(getResources().getColor(R.color.material_green));
                        slidingTabLayout.setBackgroundColor(getResources().getColor(R.color.material_green));
                        mDrawerLayout.closeDrawer(Gravity.START);
